<!-- Vendored verbatim from https://raw.githubusercontent.com/vercel-labs/web-interface-guidelines/main/command.md
     on 2026-09-10. MIT License, Copyright (c) 2025 Vercel Labs — see LICENSE next to this file.
     To refresh: curl -sS that URL > references/guidelines.md, then put this comment back on top. -->
